      ...
      <div className="min-h-screen bg-background pb-16 md:pb-0">
        ...
        <div className="container mx-auto px-4 py-6 max-w-2xl">
          <Card className="p-6 space-y-6">
            ...
            {(profile.instagramHandle || profile.socialMediaLink || profile.spotifyConnected) && (
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {profile.spotifyConnected && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-muted-foreground" data-testid="text-spotify-connected">
                        Spotify Connected
                      </span>
                    </div>
                  )}
          ...
          <div className="space-y-4 border-t pt-6">
            <div className="flex items-center gap-2">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs">Add your social media for social proof and to help others learn more about you</p>
                </TooltipContent>
              </Tooltip>
            </div>
            ...
            <div>
              <Label htmlFor="social-link">Other Social Media Link</Label>
              <Input
                id="social-link"
                type="url"
